...
Uses machine learning models like YOLOv8 for real-time behavior analysis (e.g., eating, lying, standing) from live video streams.
...
## Member 3
    ...
    - Function 3 -  Monitor Animal health
